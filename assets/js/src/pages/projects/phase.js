...
// 		placeholder: "Select Task Members(Mutiple)"
// 	});

// 	jQuery(".daterange2").daterangepicker({
// 		"opens": "center",
// 		timePicker: false,
// 		minDate : projectDetails.projectStart,
// 		maxDate: projectDetails.projectClose,
// 		locale: {
// 			format: 'YYYY-MM-DD'
// 		},
...
// 			jQuery('.daterange2').data('daterangepicker').setStartDate(taskDetails.taskStart);
// 			jQuery('.daterange2').data('daterangepicker').setEndDate(taskDetails.taskDeadline);
...
// 					let user =userRemove.parentElement.parentElement.parentElement.parentElement;
// 					user.remove();
// 					if (closebutton) {
// 						closebutton.remove();
// 					}
...
// 	jQuery(".selectAssignee").select2({	placeholder: "Select Asignee"});
