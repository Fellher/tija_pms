...
// // ?fr menu side menu open close
// console.log('This part of the code is working');
// const mainSidebar = document.querySelector('.main-sidebar');
// // let MainSidebarActive = mainSidebar.classList.contains('active');
// let MainSidebarActive = mainSidebar.querySelector('.active');
// // console.log(active);
// let parentElem = MainSidebarActive.parentElement.parentElement;

// parentElem.classList.add('d-block');
// let parentElem1 = MainSidebarActive.parentElement.parentElement;
// parentElem1.classList.add('active', 'open');
