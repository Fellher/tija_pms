...
document.addEventListener('DOMContentLoaded', function () {
	...
	for (const task of taskAnchor) {
		task.addEventListener('click', (e) => {
			...
			// daterangeinput.value = taskDetails.taskStart + ' to ' + taskDetails.taskDeadline;
			console.log(daterangeinput);

			console.log(dateRange);
			// modalBody.querySelector('.taskStart').value = taskDetails.taskStart;
