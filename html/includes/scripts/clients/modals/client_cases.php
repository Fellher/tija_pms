<div class="container-fluid py-7 my-4">						
   <div class="card clearfix shadow-lg my-7">
      <div class="card-header bg-light-blue">
         <h3 class="t400 mb-0 fs-20">Sales Cases                  
         </h3>
      </div>
      <div class="card-body">						
         <?php										
               ...
               <table class="table table-sm table-hover table-stripped">
                  ...
                  <tbody>
                     ...
                     foreach ($sales as $k => $sale) {
                        ...
                        <tr>
                           <td><a href="<?php echo $base ."html/?s={$s}&ss=sales&p=sale_details&saleid={$sale->salesCaseID}" ?>"><i class="uil-search-plus mx-2"></i><?php echo $sale->salesCaseName ?></a></td>
...
<div class="container-fluid mt-5 shadow-lg">
   <div class="card">
      <div class="card-header bg-light-blue">
         <h3 class="t400 mb-0 fs-20 ">Projects</h3>
      </div>									
      <div class="card-body">
         <div class="col-12">
            <?php 	
                     ...
                     <tbody>
                        ...
                        foreach ($projects as $proj => $projVal) {
                           ...
                           <tr>
                              ...
                              <td class='text-end'>
                                 <a href='' class="editProject" data-id='<?php echo $projVal->projectID ?>'><i class='uil-edit'>
