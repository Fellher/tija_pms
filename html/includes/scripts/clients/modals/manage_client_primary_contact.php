<div class="primaryContactForm" id="primaryContactForm">
   ...
   <div class="form-group my-2">
	...
	<div class="form-group my-2 d-none">
		...
		<input type="hidden" class="form-control form-control-plaintext bg-light-blue" name="clientID" id="clientID" value="<?= isset($clientID) ? $clientID : (isset($clientDetails) ? $clientDetails->clientID : '') ?>">
		<label for="primaryContact" class="text-primary"> Primary Contact Org Data  ID </label>
		<input type="hidden" class="form-control form-control-plaintext bg-light-blue" name="orgDataID" id="orgDataID" value="<?= isset($orgDataID) ? $orgDataID : (isset($clientDetails) ? $clientDetails->orgDataID : '') ?>">
		<label for="primaryContact" class="text-primary"> Primary Contact Entity ID </label>
		<input type="hidden" class="form-control form-control-plaintext bg-light-blue" name="entityID" id="entityID" value="<?= isset($entityID) ? $entityID : (isset($clientDetails) ? $clientDetails->entityID : '') ?>">
	</div>
