...
// Get addresses
$addresses = EmployeeProfileExtended::get_addresses_full(['employeeID' => $employeeID, 'Suspended' => 'N'], false, $DBConn);

// Get emergency contacts
$emergencyContacts = EmployeeProfileExtended::get_emergency_contacts_full(['employeeID' => $employeeID, 'Suspended' => 'N'], false, $DBConn);
?>
