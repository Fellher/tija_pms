...
$experience = EmployeeProfileExtended::get_work_experience(['employeeID' => $employeeID], false, $DBConn);
    ...
    <div class="qualification-section">
        ...
        <div class="info-card mb-3">
            <div class="d-flex justify-content-between align-items-start">
                ...
                <?php if ($canEdit): ?>
                <div class="btn-group btn-group-sm ms-2">
                    <button class="btn btn-sm btn-icon btn-primary-light" data-bs-toggle="modal" data-bs-target="#experienceModal" onclick="editExperience(<?= $exp->experienceID ?>)"><i class="ri-edit-line"></i></button>
                    <button class="btn btn-sm btn-icon btn-danger-light" onclick="deleteExperience(<?= $exp->experienceID ?>)"><i class="ri-delete-bin-line"></i></button>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
function saveExperience(event) {
    event.preventDefault();
    document.getElementById('expStartDate').value = extractDateValue('expStartDate');
    document.getElementById('expEndDate').value = extractDateValue('expEndDate');
