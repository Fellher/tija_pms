   ...
   <div class="col-12">
      <div class="card custom-card my-3 shadow-lg">
         <div class="card-header justify-content-between">
            ...
            <div class="card-options">
               <a href="?page=leave/apply_leave_workflow" class="btn btn-primary btn-sm rounded-pill btn-wave px-4 py-0">
                     ...
                     if($myLeaveApplications) {
                        foreach ($myLeaveApplications as $key  => $application) {
                           ...
                           <tr>
                              ...
                              <td class="text-end">
                                 <a
                                 href="?page=leave/apply_leave_workflow&edit=<?php echo $application->leaveApplicationID; ?>&leaveTypeId=<?php echo $application->leaveTypeID; ?>&entitlementId=<?php echo $application->leaveEntitlementID; ?>&startDate=<?php echo $application->startDate; ?>&endDate=<?php echo $application->endDate; ?>&reason=<?php echo urlencode($application->leaveComments); ?>"
