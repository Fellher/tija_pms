...
if ($isValidAdmin || $isAdmin) {
    ...
    $unitCode = (isset($_POST['unitCode']) && !empty($_POST['unitCode'])) ? Utility::clean_string($_POST['unitCode']) : null;
    $unitName = (isset($_POST['unitName']) && !empty($_POST['unitName'])) ? Utility::clean_string($_POST['unitName']) : null;
    $unitType = (isset($_POST['unitType']) && !empty($_POST['unitType'])) ? Utility::clean_string($_POST['unitType']) : null;
    $headOfUnit = (isset($_POST['headOfUnit']) && !empty($_POST['headOfUnit'])) ? Utility::clean_string($_POST['headOfUnit']) : null;
    ...
    if($unitID) {
        ...
        $headOfUnit  && $unitDetails->headOfUnitID != $headOfUnit ? $changes['headOfUnitID'] = $headOfUnit : '';
        ...
        $headOfUnit ? $unitDetails['headOfUnitID'] = $headOfUnit: "";
        $unitDescription ? $unitDetails['unitDescription'] = $unitDescription: $errors[] = "Unit Description is required";
